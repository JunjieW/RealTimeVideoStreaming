...
public class Client {
	...
	public static void main(String argv[]) throws Exception {
		...
		System.out.println("DEGUB INFO: Host Addr & Name: " + ServerIPAddr.getHostAddress() + ", " + ServerIPAddr.getHostName());
		...
		public void actionPerformed(ActionEvent e) {
			...
			if (state == INIT) {
				...
				try {
					...
					// RTPsocket = ...
					DatagramSocket s = new DatagramSocket(RTP_RCV_PORT);
